        ...
        public PanelCreater() {
            ...
            moq.Setup(m => m.GetGamesInfo())
                .Returns(new List<GameInfo>(){
                    new GameInfo("TestGame1","I am the bone of my sword. ",0,root+"\\1\\game\\DOUTONBORI.exe",root+"\\1\\panel\\icon.png",new string[]{root+"\\1\\panel\\img1.png"},"",new GameController[0], new Tag[]{new Tag("4人プレイ",Colors.DarkRed),new Tag("友達作れよ",Colors.GreenYellow) }),
                    new GameInfo("TestGame2","Steel is my body,and fire is my blood. ",0,root+"\\2\\game\\STG.exe",root+"\\2\\panel\\icon.png",new string[]{ root + "\\2\\panel\\img1.png" },"",new GameController[0], new Tag[]{new Tag("バグは仕様",Colors.Khaki),new Tag("バグだらけ",Colors.Bisque) }),
                    ...
                    new GameInfo("TestGaaaaaa\naaaaaaaame4","Unaware of loss. ",0,root+"\\4\\game\\STG.exe",root+"\\4\\panel\\icon.png",new string[]{ root + "\\4\\panel\\img1.png" },"",new GameController[]{GameController.Xbox},new Tag[]{new Tag("ムズ",Colors.Aqua),new Tag("クソゲー",Colors.Green)}),
                    new GameInfo("０１２３４５６７８９ＡＢＣＤＥＦ０１２３４５６７８９","Nor aware of gain. ",0,root+"\\1\\game\\DOUTONBORI.exe",root+"\\1\\panel\\icon.png",new string[]{ root + "\\1\\panel\\img1.png" },"",new GameController[0], new Tag[]{new Tag("神ゲー",Colors.Aqua),new Tag("God",Colors.Pink),new Tag("ﾎｳｼﾞｮｳｴﾑｩ",Colors.Violet)}),
                    new GameInfo("TestGame6","Withstood pain to create weapons, ",0,root+"\\2\\game\\STG.exe",root+"\\2\\panel\\icon.png",new string[]{ root + "\\2\\panel\\img1.png" },"",new GameController[0], new Tag[]{new Tag("文祭",Colors.Blue),new Tag("委員",Colors.Violet),new Tag("やめ",Colors.Green),new Tag("たい",Colors.Brown),}),
